...
public class RazerController extends Joystick {
	...
	public boolean xbutton_pressed() {
		if (super.getRawButtonPressed(3))
			return true;
		else
			return false;
	}
	...
	public boolean abutton_pressed() {
		if (super.getRawButtonPressed(1))
			return true;	
		else
			return false; 
	}
	...
	public boolean bbutton_pressed() {
		if (super.getRawButtonPressed(2))
			return true;
		else
			return false;
	}
	...
	public boolean ybutton_pressed() {
		if (super.getRawButtonPressed(4))
			return true;
		else
			return false;	
	}
	...
	public boolean rtbutton_pressed() {
		if (super.getRawButtonPressed(6))
			return true;
		else
			return false;			
	}	
	...
	public boolean ltbutton_pressed() {
		if (super.getRawButtonPressed(5))
			return true;
		else
			return false;			
	}	
